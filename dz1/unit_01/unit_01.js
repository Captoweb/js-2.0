...
document.querySelector('.three').innerHTML = '<h3>Hello JavaScript</h3>';
...
document.querySelector('.four').innerHTML = '<h4>JavaScript</h4>';
document.querySelector('.four').innerHTML += '<p>Hello lorem ipsun<p>';
...
let y1 = 6;
let y2 = 3;
document.querySelector('.result').innerHTML = y1 / y2;
...
let x1 = 'Hello';
let x2 = 5;
document.querySelector('.output').innerHTML = x1 + x2; // Получается конкатенация: строка + число
...
console.log(divS3); // значение переменной перезаписалось
