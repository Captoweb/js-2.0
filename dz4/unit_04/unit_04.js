...
function f5() {
    let check2 = document.querySelector('.i-5');
    
    if(check2.checked) {
        document.querySelector('.out-5').innerHTML = check2.value;
    }
    else{
...
function f7() {
    ...
    else if( document.querySelector('.i-7').value.length < 6) {
...
function f8() {
   ...
   let div8 = document.querySelector('.out-8');
    div8.innerHTML = "<input class='i-81'><br><button class='b-81'>b-81</button><div class='out-81'></div>"; 
...
function f9() {
  ...
  if (rad.checked ) {
      document.querySelector('.out-9').innerHTML = rad.value; 
  }
    else {
...
function f11() {
    let color2 = document.querySelector('.i-111').value;
    document.querySelector('.i-112').value = color2;  
}

document.querySelector('.b-11').onclick = f11; 

// Task 12
//   Создайте input(date).i-12 и button.b-12 - при нажатии на кнопку выводите  в  out-12 выбранное в input время.
...
function f13() {
    ...
    let rang = document.querySelector('.i-13');
    document.querySelector('.out-13').innerHTML = rang.value;  
}
...
function f16() {
    ...
    document.querySelector('.out-16').innerHTML = sel.value;
...
function f17() {
    //console.log(document.querySelector('.s-17').value);
...
function f19() {
   ...
   let inp19 = document.querySelector('.i-191');
   let pas19 = document.querySelector('.i-192');
   
   out19.innerHTML = inp19.value + ' ' + pas19.value; 
}
